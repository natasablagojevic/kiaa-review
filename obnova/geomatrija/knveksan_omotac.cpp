...
int main()
{
    vector<Tacka> tacke = {{-7, 8}, {-4, 6}, {2, 6}, {6, 4}, {8, 6}, {7, -2}, {4, -6}, {8, -7}, {0, 0}, {3, -2}, {6, -10}, {0, -6}, {-9, -5}, {-8, -2},
                           {-8, 0}, {-10, 3}, {-2, 2}, {-10, 4}};

    vector<Tacka> omotac = konveksan_omotac(tacke);

    sort(omotac.begin(), omotac.end(), [](Tacka &t1, Tacka &t2) {
        return t1.x < t2.x || (t1.x == t2.x && t1.y < t2.y);
    });
